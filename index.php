...
<body>
            ...
            <div class="collapse navbar-collapse" id="navbarSupportedContent">
                <ul class="navbar-nav mx-auto">
                    <li class="nav-item">
                        <a class="nav-link text-uppercase pr-5" href="#">Wine adventure</a>
                    </li>
                    <li class="nav-item active">
                        <a class="nav-link text-uppercase px-2" href="#">Accueil <span class="sr-only">(current)</span></a>
                    </li>
                    <li class="nav-item">
                    ...
                    <li class="nav-item">
                        <a class="nav-link text-uppercase px-2" href="#">Tarif</a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link text-uppercase px-2" href="#">Contact</a>
                    </li>
